/**
 * packages/templates/src/t4-cooking/layouts/MoneyPage.tsx — T4 Cooking money
...
export function MoneyPage({ site, page }: TemplateComponentProps) {
  ...
  return (
    <>
      <HeroCookingClass title={page.title} heroImageUrl={page.heroImageUrl} ctaHref={primaryTourHref} ctaLabel={ctaStyle.primaryLabel} />
      {page.bodyHtml ? <ClassBrief heading="What to expect" bodyHtml={page.bodyHtml} /> : null}
