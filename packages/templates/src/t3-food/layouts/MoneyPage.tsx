/**
 * packages/templates/src/t3-food/layouts/MoneyPage.tsx — T3 Food money page:
 * hero, body copy, tour comparison, FAQ, closing CTA.
 */
...
export function MoneyPage({ site, page }: TemplateComponentProps) {
  ...
  return (
    <>
      <HeroAppetite title={page.title} heroImageUrl={page.heroImageUrl} ctaHref={primaryTourHref} ctaLabel={ctaStyle.primaryLabel} />
